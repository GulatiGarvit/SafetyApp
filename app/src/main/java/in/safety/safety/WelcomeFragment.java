...
public class WelcomeFragment extends Fragment {
    ...
    public void setOnButtonClickedListener(buttonAction buttonAction){
    ...
    private View view;
    private Button loginButton, signupButton, anonymousButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        anonymousButton = view.findViewById(R.id.btn_login_anonymous);
